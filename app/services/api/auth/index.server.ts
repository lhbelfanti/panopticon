...
import type { LogInRequestBodyDTO, LogInResponse, SignUpRequestBodyDTO } from './types';

const delay = (ms: number) => new Promise((resolve) => setTimeout(resolve, ms));

export const signup = async (requestBody: SignUpRequestBodyDTO): Promise<{ success: boolean; message: string }> => {
