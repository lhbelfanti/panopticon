...
export const RegisterForm = (props: RegisterFormProps) => {
    ...
    return (
        <div className="flex flex-col animate-in fade-in slide-in-from-right-4 duration-300">
            <h1 className="text-3xl font-bold text-white-1 mb-2">{t('login.register.title')}</h1>
            ...
            <form className="flex flex-col gap-6" onSubmit={(e) => { e.preventDefault(); setView("login"); }}>
                ...
                <div className="flex gap-4">
                    <div className="flex flex-col gap-2 w-1/2">
                        <label className="text-sm font-semibold text-light-gray tracking-wide" htmlFor="reg-firstname">
                    ...
                    <div className="flex flex-col gap-2 w-1/2">
                        <label className="text-sm font-semibold text-light-gray tracking-wide" htmlFor="reg-lastname">
                ...
                <div className="flex flex-col gap-2 relative">
                    <label className="text-sm font-semibold text-light-gray tracking-wide flex justify-between items-center" htmlFor="reg-username">
                ...
                <div className="flex flex-col gap-3 mt-2">
                    ...
                    <p className="text-center text-sm text-light-gray-70 mt-2">
                        {t('login.register.haveAccount')} <button type="button" onClick={() => setView("login")} className="text-primary hover:text-primary/70 font-medium tracking-wide bg-transparent border-none p-0 cursor-pointer">{t('login.register.loginHere')}</button>
                    </p>
                </div>
            </form>
        </div>
