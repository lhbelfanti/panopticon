  ...
  return (
    <div className="fixed top-6 right-6 lg:right-8 z-[100]" ref={dropdownRef}>
      <button
        ...
        className="p-3 rounded-full bg-surface-dark border border-white/10 text-light-gray-70 hover:text-background-dark hover:bg-primary hover:border-transparent hover:scale-105 transition-all shadow-xl cursor-pointer flex items-center justify-center"
      >
        <Globe size={22} />
      </button>
